...
export default class PostDiploma extends Component{
  render() {
    return (
 ...
 <View style={styles.boxone}>
    ...
    <TouchableOpacity style={[styles.buttonContainer, styles.signupButton]} 
        onPress={() => this.props.navigation.navigate('Job')} >
          ...
          <Text style={styles.signUpText}>Tool Design</Text>

<View style={styles.textcontain}>
<Text style={styles.contentview}>Duration :1 years </Text>
<Text style={styles.contentview}> Qualification : NTTF Dipolma</Text>
...
<Text style={styles.contentview}> Qualification : NTTF Dipolma</Text>
  ...
  onPress={() => this.props.navigation.navigate('Job')} >
          ...
          <Text style={styles.signUpText}>Industrial Automation</Text>
