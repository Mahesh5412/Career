 ...
 <View style={styles.boxone}>
    ...
    <TouchableOpacity style={[styles.buttonContainer, styles.signupButton]} 
        onPress={() => this.props.navigation.navigate('Job')} >
          ...
          <Text style={styles.signUpText}>Body and Painting Technician</Text>
...
<View style={styles.boxtwo}>
  ...
  onPress={() => this.props.navigation.navigate('Job')} >
          ...
          <Text style={styles.signUpText}>Automobile Painting</Text>
...
<View style={styles.boxthree}>
  ...
  onPress={() => this.props.navigation.navigate('Job')} >
          ...
          <Text style={styles.signUpText}>Automobile Welding</Text>
