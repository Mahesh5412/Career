...
<module external.linked.project.id=":react-native-pdf" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.github.barteksc:pdfium-android-1.9.0" level="project" />
    ...
    <orderEntry type="library" name="Gradle: com.github.barteksc:android-pdf-viewer-3.1.0-beta.1" level="project" />
